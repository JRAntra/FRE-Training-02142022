...
// // for (let x = 0; x<reduceThisArray.length; x++){
// //     console.log (x + " " + reduceThisArray[x]);
// // }
...
// const reducedValue = myarr.myReduce ((acc, num) => acc + num);
...
// const newarr = myarr.myMap((ele, index) => {
//     return ele * 2;
// });
